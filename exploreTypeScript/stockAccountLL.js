...
var CompanyShares = /** @class */ (function () {
    ...
    CompanyShares.prototype.getName = function () {
        return this.name;
    };
    CompanyShares.prototype.setName = function (name) {
        this.name = name;
    };
    CompanyShares.prototype.getSymbol = function () {
        return this.symbol;
    };
    CompanyShares.prototype.setSymbol = function (symbol) {
        this.symbol = symbol;
    };
    CompanyShares.prototype.getPrice = function () {
        return this.price;
    };
    CompanyShares.prototype.setPrice = function (price) {
        this.price = price;
    };
